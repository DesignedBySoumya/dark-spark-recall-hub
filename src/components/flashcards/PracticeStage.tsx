...
const PracticeStage = () => {
  ...
  const { saveStudySession } = useSupabaseSync();
  ...
  useEffect(() => {
    if (studySession.total >= cards.length && !sessionComplete) {
      ...
      saveStudySession({
        totalCards: studySession.total,
        correctAnswers: studySession.correct,
        incorrectAnswers: studySession.incorrect,
        durationMinutes: Math.max(1, durationMinutes), // At least 1 minute
      });
    }
  }, [studySession.total, cards.length, sessionComplete, sessionStartTime, saveStudySession]);
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 text-center">
        ...
        >
          ...
          <p className="text-[#93A5CF] mb-8">
            Great job! Your progress has been saved. Come back tomorrow to review your cards again.
          </p>
    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="flex justify-center mb-8">
        <AnimatePresence>
          <motion.div
            ...
            className="bg-[#1C2541] rounded-2xl p-8 w-full max-w-2xl min-h-[400px] border border-[#2563EB]/20 cursor-grab active:cursor-grabbing relative overflow-hidden"
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-6">
                <div className="flex gap-2">
                  ...
                  {currentCard.subject && (
                    <Badge variant="secondary" className="bg-[#0A0E27] text-[#93A5CF]">
                      {currentCard.subject}
                    </Badge>
                  )}
                </div>
      ...
      <div className="flex justify-center gap-8">
        <motion.button
          ...
          className="bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-400 rounded-full p-4 transition-colors"
        >
          <X size={32} />
        </motion.button>
        ...
        <motion.button
          ...
          className="bg-[#2563EB]/20 hover:bg-[#2563EB]/30 border border-[#2563EB]/30 text-[#2563EB] rounded-full p-4 transition-colors"
        >
          <RotateCcw size={32} />
        </motion.button>
        ...
        <motion.button
          ...
          className="bg-green-500/20 hover:bg-green-500/30 border border-green-500/30 text-green-400 rounded-full p-4 transition-colors"
        >
          <Check size={32} />
        </motion.button>
      </div>
